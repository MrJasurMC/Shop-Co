      ...
      <div className="mb-8 md:mb-[50px]">
        ...
        <div className="mb-[50px]">
          <div className="flex flex-wrap gap-[50px]">
            ...
            <div className="w-full md:w-[610px] md:h-[241px] h-auto border border-black/10 rounded-[16px] p-6 flex flex-col gap-[10px]">
              ...
              <p className="w-full md:w-[522px] text-[16px] text-[#333] leading-[22px]">
